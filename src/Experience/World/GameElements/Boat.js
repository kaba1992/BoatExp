...
export default class Boat {
  ...
  setupAdditionalComponents() {
    ...
    this.ThirdPersonCamera = new ThirdPersonCamera({ camera: this.camera, target: this.model, canUpdate: this.canUpdate})
