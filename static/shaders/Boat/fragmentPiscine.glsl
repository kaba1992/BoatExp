...
void main() {
    ...
    // depthDifference += displacement.x * _SurfaceDistortionAmount;
            // gl_FragColor.rgb =mix(_FoamColor, waterColor.rgb, step(0.01, depthDifference));
